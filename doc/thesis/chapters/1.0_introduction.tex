...
Two bacterial mass spectrometry data sets generated in SciLifeLab were used to test the performance of the pipeline. The pipeline was then compared to other established methods of processing mass spectrometry data and compared to the newly created pipeline.
