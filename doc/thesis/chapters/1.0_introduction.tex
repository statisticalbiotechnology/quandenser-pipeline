...
A GUI was created embedded in the container to simplify modifying and running the pipeline, to allow users to easily modify and run the pipeline to their choosing.
