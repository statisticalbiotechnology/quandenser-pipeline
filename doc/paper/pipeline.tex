...
memory. MaxQuant version 1.6.3.3 was used to process the data sets using while the fasta file used was generated from Swissprot 2019-04-11. Quandenser-pipeline was processed on the same local computer, and also on the HPC cluster Rackham at UPPMAX.
...
QP parallel (HPC) & X & 28.6 & 15.2 \\ % NOTE: Nextflow does not seem to calculate these correctly. Check trace
