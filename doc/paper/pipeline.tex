...
QP parallel (HPC) & X & 2h 40m & 1h 52m \\  % X & 3h 48m & 2h 39m
QP non-parallel (HPC) & X & 2h 38m & 2h 11m \\  % X & 2h 50m & 2h 3m
...
The performance of Quandenser-pipeline was significantly faster than MaxQuant on both data sets, FIXME\% faster for the FIXME data set Comparing Quandenser-pipeline to OpenMS, Quandenser-pipeline was only slightly faster than OpenMS for both data sets.
