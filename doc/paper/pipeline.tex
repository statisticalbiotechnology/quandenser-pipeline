...
An interesting aspect of the parallelization was that on the local computer, the core hours used were slightly higher when running Quandenser-pipeline in parallel, but were slightly lower when running parallel on a HPC cluster.
