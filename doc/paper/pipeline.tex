...
FIXME data sets were tested with the pipeline. The data sets had
...
PXD002170 & Latosinska & 8 RAW files & 10.2 Gb \\
PXD001474 & Bracht & 27 RAW files & 14.8 Gb  \\
PXD009348 & Wewer (Boxcar Plasma) & 168 RAW files & 163.2 Gb & \\
\end{tabular}
\end{center}
\end{table}
...
\begin{tabular}{lccc}
&  Wewer (BoxCar Plasma) & Bracht & Latosinska \\ \hline \hline
